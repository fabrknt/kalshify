...
export async function fetchMetaplexData(): Promise<IndexData> {
    try {
        console.log("Fetching Metaplex index data...");
...
export async function calculateMetaplexScore(
    ...
    const indexData = data || (await fetchMetaplexData());
...
export async function getMetaplexCompanyData(
    ...
    const indexData = data || (await fetchMetaplexData());
    const indexScore =
        score || (await calculateMetaplexScore(indexData));
